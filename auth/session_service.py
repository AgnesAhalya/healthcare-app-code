...
def require_ui_auth(expected_user_type):
...
def require_inpatient_ui_auth(view_func):
    return require_ui_auth("inpatient")(view_func)


def require_outpatient_ui_auth(view_func):
    return require_ui_auth("outpatient")(view_func)